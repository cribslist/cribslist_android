...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            String newUserId = String.valueOf(System.currentTimeMillis() / 1000L);
            User newUser = new User(Long.parseLong(newUserId), newEmail);
            switch (displayStatus) {
                case LOG_IN:
                    CribslistClient.addUser(newUser, new CribslistClient.GetUser() {
                        @Override
                    ...
                    break;
                case REGISTER:
                    launchRegisterActivity(newUser);
                    break;
            }
        }
    }
    ...
    private void launchRegisterActivity(User user) {
